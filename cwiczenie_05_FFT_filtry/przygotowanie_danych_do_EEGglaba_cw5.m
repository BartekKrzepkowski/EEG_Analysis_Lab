...
%%  %wyciaga nazwy pojedynczych kanalow  z danymi z wejÅ›Ä‡ analogowo-cyfrowych
n1 = Ch1.title(1:3);
n2 = Ch2.title(1:3);
n3 = Ch3.title(1:3);
n4 = Ch4.title(1:3);
...
oczy_event(:,1) = Ch31.times ;  % czasy wyst?pienia znacznika !!!wpisa? z kanal o wla?ciwym numerze Ch..!!! 
oczy_event(:,2) = Ch31.codes(:,1);  %  (kod 122 – zamkniecie, 111 – otwarcie oczu)kod znacznika (unikamy 1 jedynka jest stosowana przez import z kana?u dancych 
% inne  kana?y inne znaczniki  - tworymy kolejne zmienne jak powy?ej
% odpowieeni je nazywajac


%% kody z klawiatury do zmiennej - oczywiscie jeÅ›li sa eventy zapisane z klawiatury 
