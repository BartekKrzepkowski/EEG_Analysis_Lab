...
data = [ch1; ch2; ch3; ch4; ch5];% ch7];% ch9]; %... wszystkie wpisa? 
...
sounst(:,1) = Ch6.times ;  % czasy wyst?pienia znacznika !!!wpisa? z kanal o wla?ciwym numerze Ch..!!! 
sounst(:,2) = 2;  % kod znacznika (unikamy 1 jedynka jest stosowana przez import z kana?u dancych 
